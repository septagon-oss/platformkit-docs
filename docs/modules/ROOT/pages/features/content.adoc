...
| `content:read` | a member of the tenant | `list`, `read`
| `content:manage` | a member of the tenant | `create`, `update`, `delete`, `archive`, `publish`, `unpublish`
| none: public | anyone | `public`
|===
...
| `content.content.created` | `create` | `audit` (every event)
| `content.content.updated` | `update` | `audit` (every event)
| `content.content.deleted` | `delete` | `audit` (every event)
| `content.published` | `publish` | `audit` (every event)
| `content.unpublished` | `unpublish` | `audit` (every event)
| `content.archived` | `archive` | `audit` (every event)
|===
