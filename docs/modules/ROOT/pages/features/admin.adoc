...
| `GET` | `/api/v1/admin/resources` | The resources this caller may reach, with their schemas | signed in | —
|===
...
| none: any signed-in member | a session of this tenant | `admin-resources`
|===
